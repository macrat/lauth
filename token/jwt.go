...
func (m JWTManager) CreateCode(issuer *config.URL, subject, clientID, scope, nonce string, authTime time.Time, expiresIn time.Duration) (string, error) {
...
func (m JWTManager) CreateAccessToken(issuer *config.URL, subject, scope string, authTime time.Time, expiresIn time.Duration) (string, error) {
...
func (m JWTManager) CreateIDToken(issuer *config.URL, subject, audience, nonce string, authTime time.Time, expiresIn time.Duration) (string, error) {
